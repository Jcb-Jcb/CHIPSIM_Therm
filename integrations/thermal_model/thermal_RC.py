...
def parse_args():
    ...
    parser.add_argument('--power_config_file', type=str, default='small_cluster/power_dist_small_cluster.yml', help='Power distribution configuration file')
    parser.add_argument('--power_seq_file', type=str, default='small_cluster/power_seq_small_cluster.csv', help='Power sequence file')
    parser.add_argument('--material_prop_file', type=str, default='material_prop.yml', help='Material properties file')
    parser.add_argument('--geometry_file', type=str, default='small_cluster/geometry_small_cluster.yml', help='Geometry properties file')
    parser.add_argument('--output_dir', type=str, default='./small_cluster/', help='Output directory')
    ...
    parser.add_argument('--time_heatmap', type=float, default=23, help='Time for heatmap generation in sec')
